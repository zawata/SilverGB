...
namespace Silver {
    ...
    struct [[maybe_unused]] MenuItem {
        enum Type { None, Text, SubMenu, Separator, Callback, Toggle, Radio };
        ...
        [[nodiscard]] virtual MenuItem::Type get_type() const { return MenuItem::Type::None; }
    ...
    struct [[maybe_unused]] TextMenuItem: public MenuItem {
        ...
        [[nodiscard]] MenuItem::Type get_type() const override { return MenuItem::Type::Text; }
    ...
    struct [[maybe_unused]] SeparatorMenuItem: public MenuItem {
        ...
        [[nodiscard]] MenuItem::Type get_type() const override { return MenuItem::Type::Separator; }
    };
    ...
    struct [[maybe_unused]] ToggleMenuItem: public TextMenuItem {
        ...
        ToggleMenuItem(const char *label, bool *state_toggle) :
            TextMenuItem(label), callback_mode(false), state_toggle(state_toggle) { }
        ...
        [[maybe_unused]] [[nodiscard]] bool get_default_state() const { return default_state; }

        [[nodiscard]] MenuItem::Type        get_type() const override { return MenuItem::Type::Toggle; }

    private:
        std::function<void(ToggleMenuItem &, bool, void *us_Data)> cb;
        bool                                                       callback_mode, *state_toggle, default_state;
        void                                                      *us_data {};
    };
    ...
    struct [[maybe_unused]] CallbackMenuItem: public TextMenuItem {
        ...
        CallbackMenuItem(const char *label, CallbackType cb, void *us_data = nullptr) :
            TextMenuItem(label), cb(std::move(cb)), us_data(us_data) { }

        void                         operator() () { cb(*this, us_data); }

        [[nodiscard]] MenuItem::Type get_type() const override { return MenuItem::Type::Callback; }
    ...
    struct [[maybe_unused]] Menu {
        ...
        template<typename M = MenuItem, typename... A>
        typename std::enable_if_t<std::is_base_of_v<MenuItem, M>, void> addItem(A &&...args) {
            items.emplace_back(std::make_unique<M>(args...));
        };

        void                                   addSeparator() { this->addItem<SeparatorMenuItem>(); }
    ...
    struct [[maybe_unused]] SubMenuItem: public TextMenuItem {
        ...
        explicit SubMenuItem(const char *label) :
            TextMenuItem(label), menu(std::make_unique<Menu>()) { }

        explicit SubMenuItem(const char *label, Menu &menu) :
            TextMenuItem(label), menu(std::make_unique<Menu>(std::move(menu))) { }

        ~SubMenuItem() override = default;

        [[nodiscard]] MenuItem::Type get_type() const override { return MenuItem::Type::SubMenu; }
    };
} // namespace Silver