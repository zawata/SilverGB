...
extern "C" void _audio_callback(void *userdata, uint8_t *stream, int len) {
...
void Silver::AudioManager::stop_audio() { SDL_PauseAudioDevice(*static_cast<SDL_AudioDeviceID *>(this->audio_dev), 1); }