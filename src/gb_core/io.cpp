...
void IO_Bus::write_reg(u8 loc, u8 data) {
    // TODO: I wonder if it would be better to shift the apu out of the switch and do like a
    // "will apu consume <read/write>" format, ie:
    // if (apu->will_consume_reg_write(loc, data))
