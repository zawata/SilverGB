...
inline bool _duty_check(u8 duty, u8 wv_count) {
    ...
    case 0:
        return wv_count == 4;
    case 1:
        return wv_count == 4 || wv_count == 5;
    case 2:
        return wv_count == 2 || wv_count == 3 || wv_count == 4 || wv_count == 5;
    case 3:
...
void APU::sample(float *left, float *right) {
    ...
    *right = 0.0f;
    if(snd_en()) {
        ...
        //     if(ch3_L_dac_en())
        //         mix_channel(channel_3.wav_out, channel_3.volume, left);
        //     if(ch3_R_dac_en())
        //         mix_channel(channel_3.wav_out, channel_3.volume, right);
        // }
